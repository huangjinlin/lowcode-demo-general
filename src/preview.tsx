...
import { getProjectSchemaFromLocalStorage, getPackagesFromLocalStorage, getProjectSchemaFromServer, getPackagesFromServer, getPreviewLocale, setPreviewLocale } from './services/mockService';
...
const SamplePreview = () => {
  ...
  async function init() {
    ...
    const packages = await getPackagesFromServer(scenarioName);
    // const projectSchema = getProjectSchemaFromLocalStorage(scenarioName);
    const projectSchema = await getProjectSchemaFromServer(scenarioName)
    console.log('packages', packages, 'projectSchema', projectSchema);
    const {
